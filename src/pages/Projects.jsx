...
const projectsData = [
  {
    ...
    title: "Habit Tracker",
    category: "frontend",
    tech: ["React", "TailwindCSS", "Context API", "Local Storage", "Zustand"],
  ...
  },
  {
    ...
    category: "frontend",
    tech: ["React", "TailwindCSS", "Context API", "Online Quran API", "Local Storage"],
  ...
  },
  {
    ...
    title: "B7ayemko",
    category: "frontend",
    tech: ["React", "TailwindCSS", "Redux", "Redux Persist"],
    image: B7ayemkoImg,
  ...
  },
  {
    ...
    title: "Edu Connect",
    category: "frontend",
    tech: ["React", "TailwindCSS", "Context API", "Redux"],
    image: EduConnect,
    description: "is an educational platform connecting students with teachers and courses for effective digital learning.",
  ...
  },
  {
    ...
    title: "Products",
    category: "frontend",
    tech: ["Next.js", "TailwindCSS", "Context API", "TypeScript"],
    image: Products,
